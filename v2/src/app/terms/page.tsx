    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-2xl mx-auto px-5 py-8 sm:py-10">
        ...
        <p className="text-sm text-slate-400 leading-relaxed">
          本サービスは、公開されているAI・技術関連の情報を自動で収集し、読むべきものを選り分けたうえで、日本語の要点と分析を添えてお届けする個人運営の無料サービスです。
        ...
        <H>7. 免責事項</H>
        {/* 「法令で認められる範囲で」だけを書くのは消費者契約法8条3項が無効とするサルベージ条項に当たる。
            軽過失に限る旨を明示しないと、AIの誤要約で損害が出たときに**この条項だけが丸ごと落ちる**。
            2023年6月施行の改正法に合わせて、軽過失限定＋上限額を明示する（2026-09-10 監査）。 */}
        <p className="text-sm text-slate-400 leading-relaxed">
          本サービスは「現状有姿（as-is）」で提供されます。運営者は、本サービスの利用または利用不能、
          情報の利用、サービスの中断・終了・データの消失等によって生じた損害について、
          <strong className="text-slate-300">運営者に故意または重大な過失がある場合を除き、責任を負いません。</strong>
        </p>
        <p className="text-sm text-slate-400 leading-relaxed mt-3">
          運営者に軽過失がある場合の責任は、<strong className="text-slate-300">現に発生した通常の損害に限られ、
          その総額は、利用者が当該損害の発生時点から遡って1か月間に本サービスに対して支払った対価の額（無償で
          利用されている場合は0円）を上限</strong>とします。逸失利益・事業機会の喪失・データの喪失に伴う間接損害・
          特別損害については、予見の有無にかかわらず責任を負いません。
        </p>
        <p className="text-sm text-slate-400 leading-relaxed mt-3">
          本条の定めは、消費者契約法その他の強行法規により無効とされる範囲では適用されません。
        </p>

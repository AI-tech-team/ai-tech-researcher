 ...
 *
 * ## 「言い換えているだけ」ではない（2026-09-14・n=391）
 * 一般論の正体は「何が起きたかを抽象語で書き直しているだけ」だと考えて、同じ見出しの中の
 * 2文の bigram 重なり率を測った。**外れた**: 中央値0.135・最大0.371で、言い換えと呼べる本は1本も無い。
 * しかも **具体な項目の方が重なりが高い**（0.178 vs 一般論0.125）。固有名や数字を引き継ぐと
 * 重なるので当然で、**一般論は逆に元の具体から離れていく**方向に壊れている。
 * ⇒「繰り返すな」と書く対策は的外れ。**「具体を持ってこい」と書く**のが正しい＝案Bの形で合っている。
 *

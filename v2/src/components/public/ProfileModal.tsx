      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="relative w-full sm:max-w-md max-h-[90vh] sm:max-h-[85vh] overflow-y-auto rounded-t-2xl sm:rounded-2xl border border-white/10 bg-[var(--card-bg)] shadow-2xl"
          >
